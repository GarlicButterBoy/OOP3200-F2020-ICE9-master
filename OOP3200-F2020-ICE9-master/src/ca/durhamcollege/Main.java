...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        for (int i = 0; i < 3; i+=2)
        {
            ...
            Vector2D randomVector = RandomVector.Instance().createVector2D(points.get(i), points.get(i+1));
            System.out.println("\n------------------------------------------------------------------" );
            System.out.println("Your new Vector is " + randomVector.toString() + " for the third point." );
            System.out.println("------------------------------------------------------------------\n" );
